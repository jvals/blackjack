...
class Deck {
  ...
  /**
   * This method takes a string as input with the following format: "9D, AH, 10D, ..." Every element
   * is converted to a Card object, which is stored in a Card array.
   *
  ...
  private void parseRawDeck(String rawDeck) {
    ...
    for (String cardString : deckArray) {
      ...
      switch (first) {
        ...
        default:
          throw new IllegalArgumentException(
              "The input contained a suit which was not recognized: " + String.valueOf(first));
      }
      ...
      switch (second) {
        ...
        default:
          throw new IllegalArgumentException(
              "The input contained a rank which was not recognized: " + second);
      }
